...
你可以在 [GitHub 芙檩 People](https://github.com/orgs/芙檩/people) 页面查看当前公开的组织成员列表。
...
link: "https://github.com/YashajinAlice/Snap.Hutao/issues/2333",
type: "default",
},
]'
/>
...
如果你有独特的创意并能开发出原型产品，我们同样欢迎基于非 C# .NET 技术的开发。可以通过开发者交流群与我们联系。例如，当前 Snap Hutao 的[通用后端服务](https://github.com/YashajinAlice/Generic-API) 是基于 Python FastAPI 开发的。
...
{
text: "Snap Hutao 文档",
link: "https://github.com/YashajinAlice/Snap.Hutao.Docs",
type: "default",
},
]'
/>

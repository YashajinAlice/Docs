...
你可以在 GitHub 上查看所有当前[未解决的问题](https://github.com/YashajinAlice/Snap.Hutao/issues?q=is%3Aissue%20is%3Aopen%20-label%3A%E5%B7%B2%E5%AE%8C%E6%88%90)。
...
3. 使用 Git 克隆项目仓库：`https://github.com/YashajinAlice/Snap.Hutao.git`。
4. 将分支切换到 `develop`。
...
- 可在 [Alpha 流水线](https://github.com/YashajinAlice/Snap.Hutao/actions/workflows/alpha.yml)中查看所有编译记录。
